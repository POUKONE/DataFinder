...
test("contient les surfaces principales de DataFinder", async () => {
  const [page, layout, dockerfile, datasets, apiRoute] = await Promise.all([
    readFile(new URL("../app/page.tsx", import.meta.url), "utf8"),
    readFile(new URL("../app/layout.tsx", import.meta.url), "utf8"),
    readFile(new URL("../Dockerfile", import.meta.url), "utf8"),
    readFile(new URL("../lib/datasets.ts", import.meta.url), "utf8"),
  ...
  assert.match(datasets, /Demandes de valeurs foncières/);
